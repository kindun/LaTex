...
tshark -r ../myNetworkTraffic.pcap -T fields -e frame.time -e tcp.segment_data | sort -k4 | awk '{printf($6)}' | xxd -p -r
okKTBr8=y88/pdA=ZDQkP3U=MwbMYqQ=KiZP+uA=mUKl4q4=+RV8NVY=UBcZPyY=UJddNj4=+TH2RiA=6wDoT88=u1n7aWg=lwFp5w0=BbzQg10=Qj9atMY=cGljb0NURg==ezF0X3c0cw==bnRfdGg0dA==XzM0c3lfdA==YmhfNHJfMg==ZTFmZjA2Mw==fQ==	
\end{enumerate}
\section{おわりに}
ご覧いただきありがとうございました.
