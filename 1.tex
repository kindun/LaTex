...
\begin{figure}[h]
\begin{center}
\includegraphics[width=15cm,height=45mm]{~/Pictures/Screenshots/cookie.png}
\caption{cookie}
\end{center}
\end{figure}
...
\begin{figure}[h]
\begin{center}
\includegraphics[width=15cm,height=7cm]{~/Pictures/Screenshots/cyberchef_URL.png}
\caption{URL\_decode}
\end{center}
\end{figure}
...
\begin{figure}[t]
\begin{center}
\includegraphics[width=10cm,height=5cm]{~/Pictures/Screenshots/cyberchef_base64.png}
...
\begin{enumerate}
	...
	%\begin{figure}[h]
	%\begin{center}
	%\includegraphics[width=10cm,height=5cm]{~/Pictures/Screenshots/hash_serch.png}
	%\caption{hash\_serch}
	%\end{center}
	%\end{figure}
	%\FloatBarrier
